...
class AlertPage(BasePage):
    ...
    def get_prompt_cancel(self, text):
        self.js_prompt.click()
        self.browser.switch_to_alert()
        self.browser.send_keys_to_alert(text)
        self.browser.decline_alert()
